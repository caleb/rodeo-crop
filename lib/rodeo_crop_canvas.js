...
(function() {
  ...
  CropBox = (function(_super) {
    ...
    CropBox.prototype.mouseOut = function(point) {
      return this.canvas.style.cursor = 'default';
    };

    CropBox.prototype.mouseMove = function(point) {
    ...
    CropBox.prototype.mouseDown = function(point) {};

    CropBox.prototype.mouseUp = function(point) {
      return this.dragging = null;
    };

    CropBox.prototype.dragStart = function(point) {
    ...
    CropBox.prototype.dragMove = function(point) {
    ...
    CropBox.prototype.dragEnd = function(point) {
      var frame;
      frame = this.frame();
      this.x = frame.x;
      this.y = frame.y;
    ...
    CropBox.prototype.click = function(point) {};
  ...
  window.RodeoCrop = (function() {
    ...
    RodeoCrop.prototype.attachListeners = function() {
      ...
      this.canvas.addEventListener('mouseup', function(e) {
        ...
        if (_this.dragging) {
          _this.dragging.dragEnd(pos);
          _this.dragging.mouseUp(pos);
        } else if (_this.mouseDown) {
          _this.mouseDown.mouseUp(pos);
          _this.mouseDown.click(pos);
        } else {
          pos = globalToCanvas(e);
          if (_this.cropBox.containsCanvasPoint(pos)) {
            _this.cropBox.mouseUp(pos);
          }
        }
      ...
      this.canvas.addEventListener('mousedown', function(e) {
        ...
        if (_this.cropBox.containsCanvasPoint(pos)) {
          ...
          return _this.cropBox.mouseDown(pos);
        }
      });
      return this.canvas.addEventListener('mousemove', function(e) {
        var cropboxContainsPoint, pos, _ref2;
        if (_this.dragging || _this.mouseDown) {
          pos = globalToCanvas(e);
          if (!_this.dragging) {
            _this.dragging = _this.mouseDown;
            _this.dragging.dragStart(pos);
          }
          _this.dragging.dragMove(pos);
          ...
          if (cropboxContainsPoint && _this.mouseOver !== _this.cropBox) {
            ...
            return _this.cropBox.mouseIn(pos);
          } else if (cropboxContainsPoint && _this.mouseOver === _this.cropBox) {
            return _this.cropBox.mouseMove(pos);
          } else if (!cropboxContainsPoint && _this.mouseOver === _this.cropBox) {
            _this.mouseOver.mouseOut(pos);
